                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-purple-500/50 transition-colors appearance-none cursor-pointer"
                                    >
                                        <option value="postgresql" className="bg-gray-900 text-white">PostgreSQL</option>
                                        <option value="mysql" className="bg-gray-900 text-white">MySQL</option>
                                        <option value="mongodb" className="bg-gray-900 text-white">MongoDB</option>
                                    </select>
